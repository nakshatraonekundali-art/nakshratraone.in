        ...
        <div className="hidden lg:flex lg:w-1/2 gradient-bg relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-center items-center text-center px-12 w-full">
            ...
            <p className="text-slate-300 text-lg leading-relaxed max-w-md mb-12">
              Create a new secure password to regain access to your administrative dashboard.
            </p>
            ...
            <div className="grid grid-cols-1 gap-4 max-w-sm w-full">
              ...
              <div className="glass-effect rounded-lg p-4 text-left">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-white font-medium">Password Recovery</h3>
                    <p className="text-slate-400 text-sm">Safe & reliable reset</p>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-effect rounded-lg p-4 text-left">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-white font-medium">Quick Support</h3>
                    <p className="text-slate-400 text-sm">24/7 assistance available</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="bg-red-50 border-l-4 border-red-400 rounded-lg p-4 mb-6">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-4">
                      <Link href="/admin/forgot-password" className="text-sm text-slate-600 hover:text-slate-800 font-medium transition duration-200">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 pl-12 pr-12 border text-gray-600 border-gray-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition duration-200 bg-gray-50 focus:bg-white input-focus"
