        ...
        <div className="hidden lg:flex lg:w-1/2 gradient-bg relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-center items-center text-center px-12 w-full">
            ...
            <p className="text-slate-300 text-lg leading-relaxed max-w-md mb-12">
              Access your administrative dashboard to manage your business operations with precision and control.
            </p>
              ...
              <div className="glass-effect rounded-lg p-4 text-left">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">Live business insights</p>
                  </div>
                </div>
              </div>
              ...
              <div className="glass-effect rounded-lg p-4 text-left">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400 text-sm">Control user access</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-white">
          <div className="w-full max-w-md">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 pl-12 pr-12 border text-gray-600 border-gray-300 rounded-lg focus:ring-2 focus:ring-slate-500 focus:border-transparent transition duration-200 bg-gray-50 focus:bg-white input-focus placeholder-gray-700"
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 text-slate-600 focus:ring-slate-500 border-gray-300 rounded transition duration-200"
                    checked={rememberMe}
                ...
                <div className="text-sm">
                  <Link href="/admin/forgot-password" className="font-medium text-slate-600 hover:text-slate-800 transition duration-200">
                    Forgot password?
                  </Link>
                </div>
              </div>
            ...
            <div className="mt-6 text-center space-y-2">
              ...
              <Link href="/admin/support" className="text-sm text-slate-600 hover:text-slate-800 font-medium transition duration-200">
                Contact IT Support
              </Link>
            </div>
